...
import { profileDir } from '../store/profiles.js'
...
export const vaultHandlers = {
  status: (_event, profileId: string) => vaultState(profileDir(profileId)),
